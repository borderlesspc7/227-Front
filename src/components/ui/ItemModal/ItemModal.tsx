    ...
    <div className="item-modal__backdrop" onClick={handleClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="item-modal__form">
          ...
          >
            ...
            >
              ...
              <div className="item-modal__image-upload">
                ...
                <label
                  htmlFor="item-image"
                  className="item-modal__image-label"
                  style={{
                ...
                {imagePreview && (
                  <div className="item-modal__image-preview">
                    ...
                    <button
                      type="button"
                      onClick={removeImage}
                      className="item-modal__remove-image"
                    >
                      <svg
                        width="16"
                        height="16"
          ...
          <div className="item-modal__textarea">
            <label className="item-modal__label">
              Observações
              <textarea
                name="observacoes"
